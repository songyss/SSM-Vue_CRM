...
public class CustomerController {
    ...
    public R changeCustomerStatus(
        ...
        // 如果通过请求体传递
        if (params != null && params.containsKey("id") && params.containsKey("status")) {
            int i = customerService.changeCustomerStatus(params.get("id"), params.get("status"));
            return i == 1 ? R.ok(i) : R.error();
        }
